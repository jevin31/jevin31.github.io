      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            {/* Image/Avatar side */}
            <div className="relative opacity-0 animate-slide-in-left [animation-timeline:view()] [animation-range:entry_0%_entry_30%]">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="mt-8 flex flex-wrap justify-center lg:justify-start gap-3">
                {highlights.map(({ icon: Icon, label }) => (
                  <div
                    key={label}
                    className="flex items-center gap-2 px-4 py-2 rounded-lg bg-card border border-border text-sm font-medium text-foreground hover:border-primary/50 transition-colors"
                  >
